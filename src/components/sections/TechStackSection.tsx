...
const TechStackSection: FC = () => {
  return (
    <section className="w-full md:w-275 h-auto md:h-130 shrink-0 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 md:p-6 flex flex-col relative transition-all duration-300 shadow-sm">
